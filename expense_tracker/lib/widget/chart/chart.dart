...
class Chart extends StatelessWidget {
  ...
  double get maxTotalExpense {
    ...
    for (final bucket in buckets) {
      if (bucket.totalExpenses > maxTotalExpens) {
        maxTotalExpens = bucket.totalExpenses;
      }
    }
                ...
                for (final bucket in buckets)
                  ChartBar(
                    fill: maxTotalExpense > 0
                        ...
                        : 0,
                    percentage: maxTotalExpense > 0
                        ? '${(bucket.totalExpenses / maxTotalExpense * 100).toStringAsFixed(0)}%'
                        : '0%',
                  ),
              ],
            ),
